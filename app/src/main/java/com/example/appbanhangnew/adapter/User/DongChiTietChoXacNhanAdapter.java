...
public class DongChiTietChoXacNhanAdapter extends BaseAdapter {
    Context context;
    ArrayList<ChiTietDonHang> arrayListDonhang;

    public DongChiTietChoXacNhanAdapter(Context context, ArrayList<ChiTietDonHang> arrayListDonhang) {
