...
public class ButtonAdapter extends RecyclerView.Adapter<ButtonAdapter.ItemHolder> {
    ...
    public ButtonAdapter(Context context, SanPham sanPham, ChitietSPs chitietSPs) {
        ...
        public ItemHolder(View itemView){
            ...
            button_chitiet.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    PopChonSPActivity.txtGiaChitiet.setText("Giá: "+ decimalFormat.format(chitietSPs.getChitiet(getAdapterPosition()).getGia())+" Đ");
