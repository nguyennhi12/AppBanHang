...
public class SPSearchAdapter extends RecyclerView.Adapter<SPSearchAdapter.ItemHolder> {

    Context context;
    ArrayList<SanPham> arrSp;
    ArrayList<ChitietSPs> arrayListsChitietSP;

    public SPSearchAdapter(Context context, ArrayList<SanPham> arrSp, ArrayList<ChitietSPs> arrayListsChitietSP) {
