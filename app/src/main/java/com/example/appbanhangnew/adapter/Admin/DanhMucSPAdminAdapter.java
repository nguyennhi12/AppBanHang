...
public class DanhMucSPAdminAdapter extends BaseAdapter {
    Context context;
    ...
    public DanhMucSPAdminAdapter(Context context, ArrayList<SanPham> arrayListSanPham, ArrayList<ChitietSPs> arrayListsChitietSP) {
