...
public class ChiTietLoadDonHangAdminAdapter extends BaseAdapter {
    Context context;
    ArrayList<ChiTietDonHang> arrayListDonhang;

    public ChiTietLoadDonHangAdminAdapter(Context context, ArrayList<ChiTietDonHang> arrayListDonhang) {
