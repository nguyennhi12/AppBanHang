...
import com.example.appbanhangnew.adapter.Admin.DanhMucSPAdminAdapter;
...
public class SanPhamActivity extends AppCompatActivity {
    ...
    DanhMucSPAdminAdapter danhmucAdapter;
    ...
    private void LoadmoreData() {
        listViewDanhMuc.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent= new Intent(getApplicationContext(), ChiTietSPAdminActivity.class);
    ...
    private void Anhxa() {
        ...
        danhmucAdapter =new DanhMucSPAdminAdapter(getApplicationContext(),arrayListSanPham,arrayListsChitietSP);
